    ...
    <section className="w-full space-y-16 animate-fade-in">
      <div className="space-y-6">
        ...
        <div className="text-neutral-600 dark:text-neutral-300 leading-relaxed text-sm space-y-4">
          <p>
            I love to build helpful internet things. I enjoy building products that help people solve their problems.
          </p>
          <p>
            This is my personal website where I share my thoughts, projects, and about my pasts.
          </p>
          <p>
